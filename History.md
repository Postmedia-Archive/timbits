0.7.3 / 2014-12-08
==================
  * Removed use of twitter API v1.0 in templates generated by 'timbits g' and README or examples
  * Added support for all methods on timbit endpoints, default support for GET enabled for backward compatibility
  * Example timbit added to demonstrate http POST method use
  * Testing updated to check and use GET/POST depending on which the timbit supports.
